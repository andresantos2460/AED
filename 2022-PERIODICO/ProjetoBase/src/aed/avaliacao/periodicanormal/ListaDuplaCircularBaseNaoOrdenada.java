...
public class ListaDuplaCircularBaseNaoOrdenada<T> implements ColecaoIteravelLinearNaoOrdenada<T> {
    ...
    public void transferir(ListaDuplaCircularBaseNaoOrdenada<T> outra) {
        //todo pergunta 2.


        while(!outra.isVazia()){
           No noATransferir=outra.base.anterior;
           outra.base.anterior= noATransferir.anterior;
           noATransferir.anterior.seguinte=outra.base;
            outra.numeroElementos--;

           noATransferir.seguinte=base.seguinte;
           noATransferir.seguinte.anterior=noATransferir;
           base.seguinte=noATransferir;
           noATransferir.anterior=base;
           numeroElementos++;
        }
