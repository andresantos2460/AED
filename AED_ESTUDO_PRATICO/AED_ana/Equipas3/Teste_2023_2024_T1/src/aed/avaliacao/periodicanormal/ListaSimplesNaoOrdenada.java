...
public class ListaSimplesNaoOrdenada<T> implements ColecaoIteravelLinearNaoOrdenada<T> {
    ...
    public void moverPrimeiroParaOFim() {
        //todo pergunta 2)
        ...
        // Armazena o primeiro nó (primeiro elemento da lista)
        No primeiro = base.seguinte;

        // Atualiza o início da lista para o segundo nó
        base.seguinte = primeiro.seguinte;

        // Move o nó armazenado para o final da lista
        noFinal.seguinte = primeiro;

        // Atualiza o "próximo" do antigo primeiro nó para apontar para o nó base
        primeiro.seguinte = base;

        // Atualiza a referência do último nó para o antigo primeiro nó
        noFinal = primeiro;
    }
