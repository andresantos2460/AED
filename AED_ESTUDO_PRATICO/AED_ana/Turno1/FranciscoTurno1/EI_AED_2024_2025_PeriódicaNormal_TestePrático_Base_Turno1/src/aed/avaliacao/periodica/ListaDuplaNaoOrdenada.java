...
public class ListaDuplaNaoOrdenada<T> implements ColecaoIteravelLinearNaoOrdenada<T> {
    ...
    //todo pergunta 2.
    public class IteradorPrimeirosCincoElementos implements IteradorIteravelDuplo<T> {
        private No anterior;
        private No corrente;
        private No seguinteAoUtimo;

        public IteradorPrimeirosCincoElementos() {
        }
    ...
    public IteradorIteravelDuplo<T> iteradorPrimeirosCincoElementos() {
        return new IteradorPrimeirosCincoElementos();
    }
