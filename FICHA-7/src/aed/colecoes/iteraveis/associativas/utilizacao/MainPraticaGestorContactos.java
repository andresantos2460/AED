...
public class MainPraticaGestorContactos {
    ...
    public static void main(String[] args) {
        Contacto[] contactosOriginais = new Contacto[]{
                ...
                new Contacto("ANDRE", "Santos", 971234567, "Praça", new Data(18, 3, 2004)),
        ...
        System.out.println(GestorContactos.INSTANCIA.consultar(numeroTelefone1));

        GestorContactos.INSTANCIA.remover(numeroTelefone1);

        Data data1 = new Data(18, 3, 1994);

        System.out.println("Moradas da data: " + data1);
        for (String morada : GestorContactos.INSTANCIA.consultarMoradas(data1)) {
        ...
        for (Contacto contacto : GestorContactos.INSTANCIA.consultar(data1, morada1)) {
            System.out.println(contacto);
        }
