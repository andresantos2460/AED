...
import aed.colecoes.iteraveis.lineares.ordenadas.estruturas.ArvoreBinaria;
...
public class MainTeoricaArvoreBinaria {
    ...
    private MainTeoricaArvoreBinaria() {
        ArvoreBinaria<Pessoa> arvoreBinariaPessoasNome = new ArvoreBinaria<>(ComparacaoPessoasPorNomeAsc.CRITERIO);
        ...
        for (Pessoa pessoa : arvoreBinariaPessoasNome.consultar(new Pessoa(0, "Q"), new Pessoa(0, "R"))) {
        ...
        System.out.println("\nPessoa na 4ª posição: " + arvoreBinariaPessoasNome.consultarPorIndice(3));
