...
public class Contacto implements Serializable {
    ...
    private float distanciaALeiria;

    public Contacto(String primeiroNome, String ultimoNome, long numeroTelefone, String morada, Data dataNascimento, float distanciaALeiria) {
        this.primeiroNome = primeiroNome;
        this.ultimoNome = ultimoNome;
        this.numeroTelefone = numeroTelefone;
        this.morada = morada;
        this.dataNascimento = dataNascimento;
        this.distanciaALeiria = distanciaALeiria;
    }
    ...
    public float getDistanciaALeiria() {
        return distanciaALeiria;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (Float.compare(distanciaALeiria, contacto.distanciaALeiria) != 0) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (distanciaALeiria != 0.0f ? Float.floatToIntBits(distanciaALeiria) : 0);
        return result;
    }
