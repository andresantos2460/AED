...
public class GestorImoveisMediaTotal implements Serializable {
	...
	public GestorImoveisMediaTotal(String tipologia) {
	...
	public boolean equals(Object o) {
		...
		GestorImoveisMediaTotal obj = (GestorImoveisMediaTotal) o;
	...
	public void inserir(Imovel imovel) {
		...
		this.media=precoTotal/numeroImoveis;
	}
	...
	public Integer getNumeroImoveis() {
