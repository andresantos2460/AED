...
public enum GestorContactos {
    ...
    public static final IteradorIteravel<String> ITERADOR_STRINGS_VAZIO = new ListaSimplesNaoOrdenada<String>().iterador();
    private TabelaHashOrdenada<Data, GestorContactosDataNascimento> contactosPorDataNascimento;
    private TabelaHashComIncrementoPorHash<Long, Contacto>  contactoPorNumeroTelefone;

    GestorContactos() {
        contactosPorDataNascimento = new TabelaHashOrdenada<>(ComparacaoDatasPorDataAsc.CRITERIO, 2);
        contactoPorNumeroTelefone = new TabelaHashComIncrementoPorHash<>(2);
    }

    public void inserir(Contacto contacto) {
        contactoPorNumeroTelefone.inserir(contacto.getNumeroTelefone(), contacto);
    ...
    public IteradorIteravelDuplo<Contacto> remover(Data dataNascimento) {
        ...
        for (Contacto contacto : iterador) {
            contactoPorNumeroTelefone.remover(contacto.getNumeroTelefone());
        }
        iterador.reiniciar();
        return iterador;
    }
    ...
    public Contacto remover(Contacto contacto) {
        ...
        if (!contacto.equals(contactoPorNumeroTelefone.consultar(numeroTelefone))) {
            return null;
        }
        Contacto contactoRemovido = contactoPorNumeroTelefone.remover(numeroTelefone);
    ...
    public Contacto consultar(long numeroTelefone) {
      return contactoPorNumeroTelefone.consultar(numeroTelefone);
    }

    public Contacto remover(long numeroTelefone) {
        Contacto contactoRemovido = contactoPorNumeroTelefone.remover(numeroTelefone);
        return contactoRemovido == null ? null : removerDosContactosDataNascimento(contactoRemovido);
    }

    private Contacto removerDosContactosDataNascimento(Contacto contactoRemovido) {
    ...
    public IteradorIteravel<String> consultarMoradas(Data dataNascimento) {
        ...
        return contactosDataNascimento == null ? ITERADOR_STRINGS_VAZIO :contactosDataNascimento.getMoradas();
    ...
    public IteradorIteravelDuplo<Contacto> consultar(Data dataNascimento,String morada) {
        ...
        return contactosDataNascimento == null ? ITERADOR_CONTACTOS_VAZIO : contactosDataNascimento.getContactos(morada);
    }
